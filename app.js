...
const products = {
    skates: [
        { id: 1, name: "Neon Phantom Deck", price: 4500, img: "C:\Users\ermur\OneDrive\Рабочий стол\skateshop\images\skate1.jpg", description: "Прочная дека из 7 слоев канадского клена. Идеально подходит для стрита и парка. Неоновый дизайн светится в темноте.", sizes: ["8.0\"", "8.25\"", "8.5\""], reviews: [{author: "StreetRider", rating: "★★★★★", text: "Лучшая доска, что у меня была!"}, {author: "TonyH", rating: "★★★★☆", text: "Хороший щелчок, но графика могла быть ярче."}] },
